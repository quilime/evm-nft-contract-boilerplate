...
Depending on the amount of data they store and length of their code, contracts fluctuate in deployment costs and there are many tricks to optomize them. The contract included in this repo is not optimized for gas costs. Rather, it's intended to be a basic yet comprehensive and clear starting point to understand how NFT's work. For any optimization improvements or suggestions, submit a pull request or issue.
